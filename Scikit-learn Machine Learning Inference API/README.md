# Scikit-learn Machine Learning Inference API
...
```bash
Scikit-learn Machine Learning Inference API$ sam build
```
...
```bash
Scikit-learn Machine Learning Inference API$ sam local invoke InferenceFunction --event events/event.json
```

The SAM CLI can also emulate your application's API. Use the `sam local start-api` to run the API locally on port 3000.

```bash
Scikit-learn Machine Learning Inference API$ sam local start-api
Scikit-learn Machine Learning Inference API$ curl http://localhost:3000/classify_digit
```
...
```bash
Scikit-learn Machine Learning Inference API$ sam logs -n InferenceFunction --stack-name "scikit-learn-machine-learning-inference-api" --tail
```
...
```bash
sam delete --stack-name "scikit-learn-machine-learning-inference-api"
```
